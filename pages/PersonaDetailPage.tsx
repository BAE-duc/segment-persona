...
export const PersonaDetailPage: React.FC<PersonaDetailPageProps> = ({ currentPersona, allPersonas, readStatus, onSelectPersona, onBack }) => {
    ...
    const handleSendMessage = () => {
        ...
        setTimeout(() => {
            setMessages([...newMessages, {
                role: 'assistant',
                content: 'ご質問ありがとうございます。この機能は現在開発中です。'
            }]);
        }, 500);
    };
                            ...
                            <div className="p-4 border-t border-gray-200 bg-white rounded-b-lg">
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-grow px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                                    />
                                    <button
                                        onClick={handleSendMessage}
                                        className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-bold"
                                    >
                                        送信
                                    </button>
                                </div>
